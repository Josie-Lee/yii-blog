...
<div class="panel-title box-title" style="border-bottom:none">
    ...
    <span class="pull-right"><a href="/statics/js/site.js" class="font-12">更多>></a></span>
</div>
            ...
            <?php foreach($data['feed'] as $list):?>
                <li class="media">
                    ...
                    <div class="media-body" style="font-size: 12px;">
                        <div class="media-content"><a href="#" rel="author" data-original-title="" title=""><?=$list['user']['username']?></a>说:<?=$list['content']?>
                        </div>
